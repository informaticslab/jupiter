...
// 								//GET THE RELATIONSHIP COUNT FOR THE CONNECTED NODES
// 								d3.json("/apollo/api/lab/relations", function(error, relationsJson){
// 									if(relationsJson==undefined | error){ 
...
// 									.attr("y", ".31em")
// 									.text(function(d) {
// 										console.log("The nodedata is: "+JSON.stringify(d));
// 										return d.name + " (" + d.label + ")" + " (" + "Connections: "+ d.relationshipCount + ")";
								...
								d3.json("/apollo/api/node/viewer/" + id, function(error, json) {
									...
									.text(function(d) { return d.name; });*/
										...
										text.append("a").attr("xlink:href", function(d) {
											...
											.text(function(d) {
												// return d.name + " (" + d.label + ")";
												return d.name + " (" + d.label + ")" + " (" + d.relationshipCount + ")";
											})
											.style("font-weight", function(d) {
												if (d.index == 0) {
													return "bold";
